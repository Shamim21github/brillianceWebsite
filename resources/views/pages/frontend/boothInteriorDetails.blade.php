            ...
            <main>
                ...
                <section class="portfolio__detail">
                    ...
                    <div class="portfolio__detail-thumb">
                        <img src="{{ asset('frontend/assets/imgs/work/4.BoothInteriors/1.jpg') }}"
                    ...
                    <div class="portfolio__detail-content">
                        <div class="container g-0 line pt-140">
                            ...
                            <div class="block-thumb">
                                <img src="{{ asset('frontend/assets/imgs//work/4.BoothInteriors/2.jpg') }}"
                            ...
                            <div class="block-gallery">
                                <img src="{{ asset('frontend/assets/imgs//work/4.BoothInteriors/3.jpg') }}"
                                    alt="Portfolio Image">
                                <img src="{{ asset('frontend/assets/imgs//work/4.BoothInteriors/4.jpg') }}"
                                    alt="Portfolio Image">
                            </div>

                            <div class="block-thumb">
                                <img src="{{ asset('frontend/assets/imgs//work/4.BoothInteriors/5.jpg') }}"
                                    alt="Portfolio Image" data-speed="0.5">
                            </div>

                            <div class="block-img-text">
                                <img src="{{ asset('frontend/assets/imgs//work/4.BoothInteriors/6.jpg') }}"
                                    alt="Portfolio Image">
                                <img src="{{ asset('frontend/assets/imgs//work/4.BoothInteriors/7.jpg') }}"
                                    alt="Portfolio Image">
