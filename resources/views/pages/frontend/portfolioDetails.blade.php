      ...
      <main>
        ...
        <section class="portfolio__detail">
          ...
          <div class="portfolio__detail-thumb">
            <img src="{{ asset ('frontend/assets/imgs/portfolio/detail/1.jpg') }}" alt="Portfolio Thumbnail" data-speed="auto">
          </div>
          ...
          <div class="portfolio__detail-content">
            <div class="container g-0 line pt-140">
              ...
              <div class="block-thumb">
                <img src="{{ asset ('frontend/assets/imgs/portfolio/detail/2.jpg') }}" alt="Portfolio Image" data-speed="0.5">
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
                    <div class="portfolio__detail-text">
                      ...
                      <div class="fonts">
                        <img src="{{ asset ('frontend/assets/imgs/portfolio/detail/shape.png') }}" alt="Font Style">
                        <ul>
              ...
              <div class="block-gallery">
                <img src="{{asset  ('frontend/assets/imgs/portfolio/detail/3.jpg') }}" alt="Portfolio Image">
                <img src="{{asset  ('frontend/assets/imgs/portfolio/detail/4.jpg') }}" alt="Portfolio Image">
              </div>

              <div class="block-thumb">
                <img src="{{asset  ('frontend/assets/imgs/portfolio/detail/5.jpg') }}" alt="Portfolio Image" data-speed="0.5">
              </div>

              <div class="block-img-text">
                <img src="{{asset ('frontend/assets/imgs/portfolio/detail/6.jpg')}}" alt="Portfolio Image">
                <img src="{{asset  ('frontend/assets/imgs/portfolio/detail/7.jpg') }}" alt="Portfolio Image">
              ...
              <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
                  <div class="portfolio__detail-btns pt-140 pb-140">
                    <a href="{{ route('portfolio-details') }}" class="wc-btn-primary btn-hover"><span></span> Prev Work</a>
                    <a href="{{ route('portfolio-details') }}" class="wc-btn-primary btn-hover"><span></span> Next Work</a>
                  </div>
                </div>
              </div>
            </div>
