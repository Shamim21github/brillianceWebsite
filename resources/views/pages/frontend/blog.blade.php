                ...
                <article class="blog__item">
                  <div class="blog__img-wrapper">
                    <a href="blog-details.html">
                      <div class="img-box">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/1.jpg') }}" alt="Blog Thumbnail">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/1.jpg') }}" alt="BLog Thumbnail">
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <article class="blog__item">
                  <div class="blog__img-wrapper">
                    <a href="blog-details.html">
                      <div class="img-box">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/2.jpg') }}" alt="Blog Thumbnail">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/2.jpg') }}" alt="BLog Thumbnail">
                      </div>
                    </a>
                  </div>
                  <h4 class="blog__meta"><a href="category.html">UI Design</a> . 02 May 2019</h4>
                  <h5><a href="blog-details.html" class="blog__title">How to manage a talented and successful de
                      sign
                      team</a></h5>
                  <a href="blog-details.html" class="blog__btn">Read More <span><i
                        class="fa-solid fa-arrow-right"></i></span></a>
              ...
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <article class="blog__item">
                  <div class="blog__img-wrapper">
                    <a href="blog-details.html">
                      <div class="img-box">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/3.jpg') }}" alt="Blog Thumbnail">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/3.jpg') }}" alt="BLog Thumbnail">
                      </div>
                    </a>
                  </div>
                  <h4 class="blog__meta"><a href="category.html">UI Design</a> . 02 May 2022</h4>
                  <h5><a href="blog-details.html" class="blog__title">How to bring fold to your startup company
                      with
                      Axtra</a></h5>
                  <a href="blog-details.html" class="blog__btn">Read More <span><i
                        class="fa-solid fa-arrow-right"></i></span></a>
              ...
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <article class="blog__item">
                  <div class="blog__img-wrapper">
                    <a href="blog-details.html">
                      <div class="img-box">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/4.jpg') }}" alt="Blog Thumbnail">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/4.jpg') }}" alt="BLog Thumbnail">
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <article class="blog__item">
                  <div class="blog__img-wrapper">
                    <a href="blog-details.html">
                      <div class="img-box">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/5.jpg') }}" alt="Blog Thumbnail">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/5.jpg') }}" alt="BLog Thumbnail">
                      </div>
                    </a>
                  </div>
                ...
                <article class="blog__item">
                  <div class="blog__img-wrapper">
                    <a href="{{ route('blog-details') }}">
                      <div class="img-box">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/6.jpg') }}" alt="Blog Thumbnail">
                        <img class="image-box__item" src="{{ asset ('frontend/assets/imgs/blog/6.jpg') }}" alt="BLog Thumbnail">
                      </div>
                    </a>
                  </div>
                  <h4 class="blog__meta"><a href="#">UI Design</a> . 02 May 2019</h4>
                  <h5><a href="{{ route('blog-details') }}" class="blog__title">How to bring fold to your startup company
                      with
                      Axtra</a></h5>
